...
class SMSsend_nine(object):
    """饿了么短信接口"""

    def __init__(self, mobile):
        self.url = "https://h5.ele.me/restapi/eus/login/mobile_send_code"
        self.header = {
            "Referer": "https://h5.ele.me/login/",
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:47.0) Gecko/20100101 Firefox/64.0'
        }
        self.mobile = mobile
